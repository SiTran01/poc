                  ...
                  GPIO_Type_Def *GPIO_Port, uint8_t TxPin, uint8_t RxPin, uint8_t AF_Mode)
{
    ...
    /* 1. C?u h�nh GPIO cho CAN (TX v� RX) 
       - Mode: Alternate Function
       - AF: AF9 (thu?ng l� v?y cho CAN1)
       - Speed: Very High
       - Output Type: Push Pull (CAN Controller t? lo vi?c l�i bus)
       - Pull-up: N�n c� cho ch�n RX d? tr�nh nhi?u khi bus r?nh
    */
    ...
    /* 3. C?u h�nh Filter d? nh?n m?i tin (ho?c ch?nh l?i n?u mu?n l?c) */
